        ...
        >
            <AuthLayout>
                <motion.div
                    ...
                    animate="visible"
                >
                    <motion.h1 variants={itemVariants} className="text-3xl font-bold text-text mb-2">Welcome Back!</motion.h1>
                    <motion.p variants={itemVariants} className="text-text-light mb-8">Please enter your credentials to log in.</motion.p>
                    ...
                    <motion.p variants={itemVariants} className="mt-6 text-center text-sm text-text-light">
                        ...
                        <Link to="/register" className="font-medium text-primary hover:text-primary-dark">Sign up</Link>
                    </motion.p>
                </motion.div>
            </AuthLayout>
        </motion.div>
